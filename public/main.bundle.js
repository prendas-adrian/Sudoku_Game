...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_user_edit_component__ = __webpack_require__("../../../../../src/app/components/user-edit.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_sudoku_component__ = __webpack_require__("../../../../../src/app/components/sudoku.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_6__components_user_edit_component__["a" /* UserEditComponent */],
            __WEBPACK_IMPORTED_MODULE_7__components_sudoku_component__["a" /* SudokuComponent */]
        ],
        imports: [
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_4__app_routing__["a" /* appRoutingProviders */]],
                ...
                _this.range.forEach(function (row) {
                    _this.range.forEach(function (col) {
                        ...
                        if (_this.grid.getCell(row, col).visible) {
                            ...
                            p.text(_this.grid.getCell(row, col).value, col * cellSize + cellSize / 4, row * cellSize + cellSize / 1.5);
                        }
...
var Game = (function () {
    ...
    Game.prototype.setCellSize = function (size) {
        this.cellSize = size;
    };
